...
apptainer exec --bind $PWD:/data --pwd /data /programs/qiime2-2025.10/qiime2_amplicon.sif qiime feature-table summarize --i-table sf_rarefied130k.qza --o-visualization sf_tablefreq.qzv --m-sample-metadata-file fwmetadatamerged.txt
